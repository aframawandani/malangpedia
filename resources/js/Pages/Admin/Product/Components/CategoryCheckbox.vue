<template>
  <div class="checkbox">
    ...
    <category-checkbox v-for="child_category in category.child_categories" :key="child_category.category_id" :form="typeof form === 'string' ? form : null" :category="child_category" :checkedCategories="checkedCategories" />
  </div>
</template>
