<template>
  <div>
            ...
            <div class="col-lg-4">
              <div class="checkout__order">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <button class="site-btn" type="button" @click="orderButtonOnClick">Pesan</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" ref="orderConfirmationModal">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button class="site-btn" type="button" @click="cancelOrderConfirmationButtonOnClick">Batal</button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    orderButtonOnClick() {
      $(this.$refs.orderConfirmationModal).modal('show');
    },
    cancelOrderConfirmationButtonOnClick() {
